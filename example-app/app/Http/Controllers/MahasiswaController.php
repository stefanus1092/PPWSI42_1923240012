...
class MahasiswaController extends Controller
{
    ...
    {
        $result = DB::insert('insert into mahasiswas (npm, nama_mahasiswa, tempat_lahir, tanggal_lahir, alamat, created_at) values(?,?,?,?,?,?)', ['1923240012', 'Stefanus Tanner', 'Palembang', '2002-09-04', 'Jl. Jendral Sudirman', now()]);
        dump($result);
    }
    
    public function update()
    {
        $result = DB::update('update mahasiswas set nama mahasiswa = "Stefanus", updated_at = now() where npm=?', ['1923240012']);
        dump($result);
    }
    
    public function delete()
    {
        $delete = DB::delete('delete from mahasiswas where npm=?', ['19232470012']);
        dump($result);
    }
